...
function LoginHelp() {
    alert("Contact your system adminstrator to find out if you're eligible for access!");
}
...
function StatusesPage() {
    ...
    document.getElementById("header").innerHTML = "Network and System Log Statuses";
}
